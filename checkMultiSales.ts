...
async function main() {
  ...
  const collection_slugs = ['avid-lines', 'pulsquares']
  const collection_adds = ['0xdfacd840f462c27b0127fc76b63e7925bed0f9d5','0x905b180268f2773022e1a10e204b0858b2e60dcf']
